...
const projects: Project[] = [
    {
        ...
        projectInfo: {
            headerImage: "/Rollingsticks/header.png",
            hideTitle: true,
            texts: [
                {
                    type: "imageText",
                    ...
                    image: "/Rollingsticks/Signin.png"
    ...
    },
    {
        ...
        mediaType: "img",
        media: "/Huiz/huizFull.png",
        projectInfo: {
            headerImage: "/Huiz/huiz.png",
            hideTitle: true,
    ...
    },
    {
        ...
        projectInfo: {
            hideTitle: true,
            headerImage: "/GoudaGo/Unity.webp",
            texts: [
                {
                    type: "videoText",
    ...
    },
    {
        ...
        description: "Bij dit project waren de opdrachtgevers dpg, gemeente Gouda en gemeente Krimpenerwaard. Zij gaven ons de opdracht om een duurzaam en circulair product te ontwikkelen. Wij kozen voor een duurzame en circulaire etui. We moesten aan het einde van het project een fysiek of digitaal eindmodel hebben, Een marketing plan die ons product presenteerd, wat het kost, waar het gemaakt word en hoe we het gaan promoten. Ook hebben we de markt verkent en in kaart gebracht hoe het er op dit moment uit ziet.",
        mediaType: "img",
        media: "/Duurzaam/etui.jpg",
        projectInfo: {
            hideTitle: true,
            headerImage: "/Duurzaam/span.png",
            texts: [
                {
                    type: "imageText",
                    title: "Duurzame en circulaire etui",
                    image: "/Duurzaam/etui.jpg",
    ...
    },
    {
        ...
        mediaType: "img",
        media: "/EnergieUitWater/Waterkracht-stuwdam.png",
        links: [
            {
                name: "Video",
        ...
        projectInfo: {
            headerImage: "/EnergieUitWater/Waterkracht-stuwdam.png",
            texts: [
                {
                    type: "videoText",
    ...
    },
    {
        ...
        projectInfo: {
            headerImage: "/GoudseCreatie/stroopwafel.jpg",
            texts: [
                {
                    type: "videoText",
    ...
    },
    {
        ...
        mediaType: "img",
        media: "/EscapeRoom/EscapeRoom.webp",
        links: [
            {
                name: "Video",
                icon: "/EscapeRoom/key.png",
    ...
    },
    {
        ...
        mediaType: "img",
        media: "/VeiligeFietsRoute/3Dontwerp.png",
        projectInfo: {
            hideTitle: true,
            headerImage: "/VeiligeFietsRoute/vvn.png",
            texts: [
                {
                    type: "imageText",
                    title: "De opdracht",
                ...
                },
                {
                    ...
                    image: "/VeiligeFietsRoute/Me.svg"
                }
            ]
        }
    },
    {
        ...
        media: "/Domino/DD.png",
        projectInfo: {
            headerImage: "/Domino/dominoday.webp",
